...
class MaintenanceTechDashboard extends StatefulWidget {
  const MaintenanceTechDashboard({super.key});

  @override
  State<MaintenanceTechDashboard> createState() =>
      _MaintenanceTechDashboardState();
}

class _MaintenanceTechDashboardState extends State<MaintenanceTechDashboard> {
