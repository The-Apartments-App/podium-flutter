...
class CommunityManagerDashboard extends StatefulWidget {
  const CommunityManagerDashboard({super.key});

  @override
  State<CommunityManagerDashboard> createState() =>
      _CommunityManagerDashboardState();
}

class _CommunityManagerDashboardState extends State<CommunityManagerDashboard> {
